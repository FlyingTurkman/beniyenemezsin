...
export default function Index() {
  return(
    <div className='flex flex-col w-full container mx-auto h-[calc(100vh-100px)] items-center justify-center'>
      <h1 className="text-center">Beni Yenemezsin</h1>
      <p className="text-justify">Kurallar basit. Bu oyunda bilgisayara karşı yarışıyorsun. Başlangıçta elimizde bir sayı oluyor. Daha sonra bu sayıdan 1 veya 2 çıkarıyorsun. 1 sayısını altına düşen oyunu kaybediyor.</p>
